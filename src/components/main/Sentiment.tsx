  ...
  return (
    <div className="bg-white p-4 md:p-8 rounded-lg flex flex-col gap-8">
      ...
      <h4 className="text-[#44475B] flex font-[500] gap-2 items-center">
        Key Events <img src="/assets/tooltip.svg" />
      </h4>
      <div className="relative">
        ...
        {showRightBtn && (
          ...
          >
            <img src="/assets/scroll-right.svg" />
          </button>
        )}
        {!showRightBtn && (
          <button
          ...
          >
            <img className="rotate-[180deg]" src="/assets/scroll-right.svg" />
          </button>
        )}
      </div>
      <h4 className="text-[#44475B] flex font-[500] gap-2 items-center">
        Analyst Estimates <img src="/assets/tooltip.svg" />
      </h4>
